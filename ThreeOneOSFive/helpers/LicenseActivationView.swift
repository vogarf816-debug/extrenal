...
struct LoginBackdrop: View {
    var body: some View {
        ZStack {
            LinearGradient(
                colors: [AppTheme.pageBackground, Color(red: 0.14, green: 0.018, blue: 0.22), AppTheme.pageBackground],
                startPoint: .topLeading,
                endPoint: .bottomTrailing
            )
            RadialGradient(colors: [AppTheme.accent.opacity(0.16), .clear], center: .topTrailing, startRadius: 10, endRadius: 300)
            RadialGradient(colors: [AppTheme.secondaryAccent.opacity(0.10), .clear], center: .bottomLeading, startRadius: 10, endRadius: 320)
        }
    }
}
